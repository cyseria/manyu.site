...
![](http://manyu-blog.oss-cn-shenzhen.aliyuncs.com/c9d5c21cfa16067fccf74808ef2e56aa.png)
...
## 四、其他
1. 对于耗时的 loader，使用 `include`，尝试对 babel-loader 和 scss-loader 进行了处理。发现…并没有明显提升。
